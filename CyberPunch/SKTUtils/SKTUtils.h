...
SKT_INLINE CGFloat CGPointDistanceSQ(CGPoint point1, CGPoint point2)
{
    CGPoint diff = CGPointSubtract(point1, point2);
    GLKVector2 vector2Diff = GLKVector2FromCGPoint(diff);
    return GLKVector2DotProduct(vector2Diff, vector2Diff);
}
...
SKT_INLINE int RandomIntRange(int min, int max) {
...
SKT_INLINE CGFloat RandomFloatRangeFloored(CGFloat min, CGFloat max) {
